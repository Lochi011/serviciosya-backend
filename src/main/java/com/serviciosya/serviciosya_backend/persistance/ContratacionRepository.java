...
public interface ContratacionRepository extends CrudRepository<Contratacion, Long> {
    Optional<Contratacion> findByDemandanteAndOfertanteAndServicioAndFecha(UsuarioDemandante demandante, UsuarioOfertante ofertante, Servicio servicio, LocalDate fecha);
